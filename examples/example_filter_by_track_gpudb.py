...
def example_filter_by_track():
    ...
    register_response = gpudb.register_type( track_schema, "", "", "TRACK" )
    ...
    get_set_obj_response = gpudb.get_set_objects( track_set_id, 0, 1, encoding = "json" )
    ...
    response = gpudb.filter_by_track( track_set_id, track_id, [], param_map, result_set_id )
