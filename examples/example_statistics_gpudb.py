...
def example_statistics():
    ...
    gpudb.random( set_id, 1000, {"x": {"min": 10, "max": 10}} )
    ...
    statistics_response_x = gpudb.statistics( set_id, "x", "sum,mean,stdv,variance,skew,kurtosis,cardinality,estimated_cardinality" )
    # The user can explicitly ask for 'count' as well
    statistics_response_y = gpudb.statistics( set_id, "y", "count,sum,mean,stdv,variance,skew,kurtosis,cardinality,estimated_cardinality" )
