...
def example_random():
    ...
    register_response = gpudb.register_type( custom_schema, "", "custom_point_type", "POINT" )
    ...
    random_response = gpudb.random( set_id, 500, param_map )
    ...
    statistics_response = gpudb.statistics( set_id, "x", "count" )
